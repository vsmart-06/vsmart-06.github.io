...
Outcome:
With this data, I wrote a research paper that outlined the results obtained, and especially its impact in the healthcare sector. With high levels of accuracy required in this field, to ensure the best diagnosis possible, any improvements in the performance will be important. I then presented the research paper at the International Conference on Engineering and Advancements in Technology, and published the paper in the International Journal of Science and Innovative Engineering and Technology.""", link: "https://arxiv.org/abs/2407.14628v1", dates: "March 2023 - August 2023"),
        "/oral-cancer-detection": (context) => ProjectPage(title: "Oral Cancer Detection Application", text: """Working under the guidance of Professor Prasad Sudhakar from IISc Bangalore, I created an application that aimed to diagnose oral cancer from images provided as input. Oral cancer is another extremely common form of cancer in India so the implications of this project were many.
...
Outcome:
The trained model returned an accuracy of around 80% on images that it had never seen before, which is a good indication of its usefulness, but not nearly good enough to be applied in a real world scenario. However, the experience obtained was useful to pioneer other such future projects.""", link: "https://tinyurl.com/oral-cancer-app-presentation", dates: "October 2022 - July 2023"),
        "/minesweeper-bot": (context) => ProjectPage(title: "Minesweeper Bot", text: "I am the creator of the Minesweeper Bot on Discord. This bot brings a multitude of different games to the platform, apart from minesweeper itself, such as Connect 4, Othello, Mastermind, Battleship, Yahtzee, Hangman, Uno, and more! This bot has achieved a lot of popularity, having been adopted in 2500+ servers on the platform!", link: "https://minesweeper-bot.carrd.co", dates: "October 2021 - December 2022"),
      },
      theme: ThemeData(
        useMaterial3: false
      ),
